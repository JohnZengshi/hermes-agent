...
def _get_env_config() -> Dict[str, Any]:
    ...
    return {
        ...
        "docker_security_mode": os.getenv("TERMINAL_DOCKER_SECURITY_MODE", "strict")
        .strip()
        .lower(),
    }
...
def _create_environment(
    ...
    docker_security_mode = cc.get("docker_security_mode", "strict")
    ...
    if env_type == "local":
        ...
        return _DockerEnvironment(
            ...
            env=docker_env,
            security_mode=docker_security_mode,
        )
                    ...
                    try:
                        ...
                        if env_type in ("docker", "singularity", "modal", "daytona"):
                            container_config = {
                                ...
                                "docker_security_mode": config.get(
                                    "docker_security_mode", "strict"
                                ),
                            }
