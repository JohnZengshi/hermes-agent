...
class TestPlatformConfigRoundtrip:
    ...
    def test_roundtrip_preserves_nested_router_config(self):
        pc = PlatformConfig(
            enabled=True,
            extra={
                "router": {
        ...
        assert restored.extra["router"]["default_backend"] == "hermes"
        assert (
            restored.extra["router"]["backends"]["doubao"]["model_id"] == "doubao-agent"
        )
