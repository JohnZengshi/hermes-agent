...
class TestAgentConfigSignature:
    ...
    def test_agent_user_id_in_signature(self):
        from gateway.run import GatewayRunner
        ...
        sig_user = GatewayRunner._agent_config_signature(
            "claude-sonnet-4",
            runtime,
            ["hermes-telegram"],
            "",
            agent_user_id="8259215216",
        )
        sig_global = GatewayRunner._agent_config_signature(
            "claude-sonnet-4",
            runtime,
            ["hermes-telegram"],
            "",
